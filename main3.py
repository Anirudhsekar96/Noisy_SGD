...
def get_parser():
    ...
    parser.add_argument('--optim', default='sgd', type=str, help='optimizer',
                        choices=['sgd', 'adagrad', 'adam', 'amsgrad', 'adabound', 'amsbound', 'ggdo','ggdo2','ggdo3','ggdo4','sgld','ggdo5','pSGLD'])
...
def get_ckpt_name(model='resnet', optimizer='sgd', lr=0.1, final_lr=0.1, momentum=0.9,
                  beta1=0.9, beta2=0.999, gamma=1e-3, noise=0.1):
    name = {
        ...
        'ggdo': 'lr{}-momentum{}'.format(lr, momentum),
        ...
        'pSGLD': 'lr{}-noise{}'.format(lr, noise),
    }[optimizer]
...
def create_optimizer(args, model_params):
    if args.optim == 'sgd':
        ...
        return AdaBound(model_params, args.lr, betas=(args.beta1, args.beta2),
                        ...
                        weight_decay=args.weight_decay)
    elif args.optim == 'ggdo':
        return ggdo.GGDO(model_params, args.lr, momentum=args.momentum,
                         weight_decay=args.weight_decay)
    elif args.optim == 'ggdo2':
        return ggdo2.GGDO(model_params, args.lr, momentum=args.momentum,
                         weight_decay=args.weight_decay, noise=args.noise)
    elif args.optim == 'ggdo3':
        return ggdo3.GGDO(model_params, args.lr, momentum=args.momentum,
                         weight_decay=args.weight_decay, noise=args.noise)
    elif args.optim == 'ggdo4':
        return ggdo4.GGDO(model_params, args.lr, momentum=args.momentum,
                         weight_decay=args.weight_decay)
        ...
        return ggdo5.GGDO(model_params, args.lr, momentum=args.momentum,
                         weight_decay=args.weight_decay, noise=args.noise)
    elif args.optim == 'pSGLD':
        return pSGLD.pSGLD(model_params, args.lr, noise=args.noise,
                         weight_decay=args.weight_decay)
